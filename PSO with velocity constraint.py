    ...
    def run(self):
        for t in range(self.maxiter):
            ...
            for k in range(self.noP):
                ...
                self.swarm['Particles'][k]['V'] = self.swarm['Particles'][k]['V'][0]
                # to constraint velocity
                for i in range(self.n_variables):
                    # print(self.swarm['Particles'][k]['V'][i],self.Vmax)
                    if self.swarm['Particles'][k]['V'][i] > self.Vmax:
                        self.swarm['Particles'][k]['V'][i] = self.Vmax
                    
                    if self.swarm['Particles'][k]['V'][i] < self.Vmin:
                        self.swarm['Particles'][k]['V'][i] = self.Vmin
